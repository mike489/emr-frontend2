...
interface SendCrossModalProps {
  open: boolean;
  onClose: () => void;
  onSend: (department: string, doctorId: string) => void;
}

const SendCrossModal: React.FC<SendCrossModalProps> = ({ open, onClose, onSend }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Cross Patient</DialogTitle>
