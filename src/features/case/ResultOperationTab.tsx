      ...
      <Box sx={{ flex: 1, p: 3, overflowY: 'auto' }}>
        {patient?.id ? (
          <>
            ...
            <ResultOperationPage patientId={patient?.id} patientName={patient?.full_name} />
          </>
        ) : (
          <Box color="error.main">No Result ID found</Box>
        )}
      </Box>
      <ToastContainer />
    </Box>
...
export default ResultOperationTab;
