...
const OperationalPaymentModal: React.FC<OperationalPaymentModalProps> = ({
  open,
  onClose,
  patientId,
  patientName,
  ...
  useEffect(() => {
    const fetchLabTests = async () => {
      ...
      try {
        ...
        setLabTests([
          {
            group_name: 'Operational Services',
            tests: operations.map(
              (op: {
                id: any;
                service_name: any;
                result: any;
                ...
                id: op.id,
                test: op.service_name,
                result: op.result,
                amount: op.amount,
                is_payment_completed: op.is_payment_completed,
                technician: op.submitter,
  ...
  const handleSubmitPayment = async () => {
    try {
      ...
      await OperationalService.createOperationPayment(patientId, paymentData);
    ...
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      <DialogTitle>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="h6">Operational Payment</Typography>
...
export default OperationalPaymentModal;
