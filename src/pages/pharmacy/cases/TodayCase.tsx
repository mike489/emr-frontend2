...
import PharmacyOrderDetailModal from '../../pharmacy_medicines_order/PharmacyOrderDetailModal';
...
const PharmacyTodayCases: React.FC = () => {
...
export default PharmacyTodayCases;
