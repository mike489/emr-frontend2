...
import GlassPrescriptionDetailPage from './GlassPrescriptionDetail';
      ...
      <Box sx={{ flex: 1, p: 3, overflowY: 'auto' }}>
        {patient?.id ? (
          <>
            ...
            <GlassPrescriptionDetailPage patientId={patient?.id} />
          </>
        ) : (
          <Box color="error.main">No Patient ID found</Box>
        )}
      </Box>
    </Box>
  );
