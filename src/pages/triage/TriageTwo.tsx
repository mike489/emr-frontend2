...
const TriageTwo: React.FC = () => {
  ...
  const getFrontDeskSummary = () => PatientSummaryService.getAll('Triage 2');
  ...
  const handleRowClick = (patient: Patient) => {
    navigate('/triage-two/patient-details', {
      state: {
