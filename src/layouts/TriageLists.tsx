      ...
      >
        ...
        >
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            <Typography variant="h6" sx={{ opacity: 0.9, fontWeight: 300 }}>
              Manage patient assessments and prioritize care
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ p: { xs: 3, md: 6 } }}>
              ...
              >
                ...
                >
                  <ModuleCard
                    title={mod?.title}
                    image={mod.icon}
                    disabled={false} // Always fully visible
          ...
          <Typography
            variant="caption"
            textAlign="center"
            sx={{ display: 'block', opacity: 0.7, color: theme.palette.primary.main }}
          >
            Secure triage access • Professional medical tools
          </Typography>
        </Box>
      </Paper>
      ...
      <Dialog
        ...
        PaperProps={{
          sx: {
            ...
            p: 1,
            maxWidth: 400,
            border: `1px solid ${alpha('#ffffff', 0.9)}`, // The white border line
      ...
      >
        <DialogContent sx={{ textAlign: 'center', pt: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Your account does not have permission for this Triage module.
          </Typography>
        </DialogContent>
