...
import { SYSTEMADMIN_MODULES } from '../config/systemadminModules';

const SystemadminLists = () => {
  ...
  const accessibleModules = SYSTEMADMIN_MODULES.filter(mod => hasPermission(mod.permission));
...
export default SystemadminLists;
