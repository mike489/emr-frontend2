...
import { DIAGNOSIS_MODULES } from '../config/diagnosisModule';
...
const DiagnosisList = () => {
  ...
  const accessibleModules = DIAGNOSIS_MODULES.filter(mod => hasPermission(mod.permission));
      ...
      >
        ...
        >
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              Advanced diagnostic tools and patient assessment
            </Typography>
          </Box>
        </Box>
        ...
        {accessibleModules.length === 0 ? (
          <Box sx={{ p: { xs: 3, md: 6 }, textAlign: 'center' }}>
            ...
            >
              You don't have permission to access any diagnosis modules.
            </Typography>
            <Box
          ...
          <Box sx={{ p: { xs: 3, md: 6 } }}>
            ...
            >
              Secure diagnostic access • Professional medical tools
            </Typography>
          </Box>
        )}
      </Paper>
